@extends('layouts.therapist-login')
...
<div class="login-wrapper d-flex justify-content-center align-items-center">
    <div class="login-card text-center">
        <h6 class="fw-bold mb-2">مرحبًا بك أيها المعالج!</h6>
        <p class="small text-muted mb-3">سجّل دخولك للوصول إلى لوحة التحكم الخاصة بك.</p>
        ...
        <div class="form-group mb-3">
            ...
            <input type="password" name="password" class="form-control custom-input" placeholder="أدخل كلمة المرور">
             <div class="text-end mt-1">
                <a href="{{ route('password.request') }}" class="tiny-text">نسيت كلمة المرور؟</a>
            </div>
        </div>

        <button type="submit" class="main-btn mb-3">
            تسجيل الدخول
        </button>
    </form>
