<section class="hero">
    ...
    <div class="content">
        <h1>لمن مرَّ بالكثير...</h1>
        <h2>ولم يجد مكانًا يستريح فيه</h2>

        <p>
            نحن ندرك أن بعض التجارب تترك آثارًا لا تُرى، لذلك صُممت سكون لتكون
            مساحة دافئة، خطوة صغيرة تساعدك على استعادة نفسك من جديد وبشكل آمن.
        </p>

        @guest
        <div class="buttons">
            <a href="#" class="btn-white" id="loginBtn">تسجيل دخول</a>
            <a href="#" class="btn-outline" id="signupBtn">إنشاء حساب</a>
        </div>
        @endguest
    </div>
</section>